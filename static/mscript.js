...
function pm10image() {
  if (pm10 < 7) {
    document.getElementById("div1").style.backgroundImage = "url('static/img/good.png')";
    pm10text = "미세먼지가 좋음입니다";
  } else if (pm10 < 15) {
    document.getElementById("div1").style.backgroundImage = "url('static/img/soso.png')";
    pm10text = "미세먼지가 보통입니다";
  } else if (pm10 < 30) {
    document.getElementById("div1").style.backgroundImage = "url('static/img/bad.png')";
    pm10text = "미세먼지가 나쁨입니다";
  } else {
    document.getElementById("div1").style.backgroundImage = "url('static/img/sobad.png')";
...
function pm25image() {
  if (pm25 < 7) {
    document.getElementById("div2").style.backgroundImage = "url('static/img/good.png')";
    pm25text = "초미세먼지가 좋음입니다";
  } else if (pm25 < 15) {
    document.getElementById("div2").style.backgroundImage = "url('static/img/soso.png')";
    pm25text = "초미세먼지가 보통입니다";
  } else if (pm25 < 30) {
    document.getElementById("div2").style.backgroundImage = "url('static/img/bad.png')";
    pm25text = "초미세먼지가 나쁨입니다";
  } else {
    document.getElementById("div2").style.backgroundImage = "url('static/img/sobad.png')";
...
function covidimage() {
  if (covid < 7) {
    document.getElementById("div3").style.backgroundImage = "url('static/img/good.png')";
    covidtext = "코로나가 좋음입니다";
  } else if (covid < 15) {
    document.getElementById("div3").style.backgroundImage = "url('static/img/soso.png')";
    covidtext = "코로나가 보통입니다";
  } else if (covid < 30) {
    document.getElementById("div3").style.backgroundImage = "url('static/img/bad.png')";
    covidtext = "코로나가 나쁨입니다";
  } else {
    document.getElementById("div3").style.backgroundImage = "url('static/img/sobad.png')";
...
function coldimage() {
  if (cold < 7) {
    document.getElementById("div4").style.backgroundImage = "url('static/img/good.png')";
    coldtext = "감기가 좋음입니다";
  } else if (cold < 15) {
    document.getElementById("div4").style.backgroundImage = "url('static/img/soso.png')";
    coldtext = "감기가 보통입니다";
  } else if (cold < 30) {
    document.getElementById("div4").style.backgroundImage = "url('static/img/bad.png')";
    coldtext = "감기가 나쁨입니다";
  } else {
    document.getElementById("div4").style.backgroundImage = "url('static/img/sobad.png')";
    coldtext = "감기가 매우나빠요";
  }
...
function yellowimage() {
  if (yellow < 7) {
    document.getElementById("div5").style.backgroundImage = "url('static/img/good.png')";
    yellowtext = "황사가 좋음입니다";
  } else if (yellow < 15) {
    document.getElementById("div5").style.backgroundImage = "url('static/img/soso.png')";
    yellowtext = "황사가 보통입니다";
  } else if (yellow < 30) {
    document.getElementById("div5").style.backgroundImage = "url('static/img/bad.png')";
    yellowtext = "황사가 나쁨입니다";
  } else {
    document.getElementById("div5").style.backgroundImage = "url('static/img/sobad.png')";
